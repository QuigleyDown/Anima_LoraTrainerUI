...
3. **Download Models**: Go to the **Models** tab and download the required base weights.
4. **Prepare Dataset**: 
...
Anima is an experimental model. LoRAs trained for preview versions may not be compatible with the final full release of Anima. It is recommended to use `bf16` mixed precision for stability.
...
While this UI code is MIT-licensed, the **Anima** model weights and their derivatives (including LoRAs and full finetunes) are subject to the **CircleStone Labs Non-Commercial License** and the **NVIDIA Open Model License Agreement**. You are responsible for ensuring your use of the model complies with their respective terms.
